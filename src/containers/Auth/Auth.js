...
class Auth extends Component {
    ...
    inputChangedHandler = (event,controlName) => {
        ...
        const updatedCtrl = {...updatedControls[controlName]};
        updatedCtrl.value = event.target.value;
        updatedCtrl.valid = this.checkValidity(updatedCtrl.value,updatedCtrl.validation);
        updatedCtrl.touched = true;
        updatedControls[controlName]=updatedCtrl;
